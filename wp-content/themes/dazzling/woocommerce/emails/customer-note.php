...
<p><?php
    if ($venue_name == '')
        _e( "Hello, your order is cancelled by area manager. They left following message:", 'woocommerce' );
    else
        _e( "An order is cancelled. You left following message:", 'woocommerce' );
    ?>
</p>
