        ...
        _initTrap: function () {
            ...
            //     self.options.onEnter();
                ...
                self.zoomDiv = $('<div class="yith_magnifier_zoom_magnifier" />').css({
                    ...
                    'background-size': self.options.zoomImageWidth + 'px ' + self.options.zoomImageHeight + 'px'
                }).appendTo(appendTo);
                ...
                if (zoomImg.width <= 1) {
                    self.cw = (zoomImage.outerWidth() / self.options.zoomImageWidth) * self.zoomDiv.width();
                } else {
                    self.cw = (zoomImage.outerWidth() / self.options.zoomImageHeight) * self.zoomDiv.width();
                }

                if (zoomImg.height <= 1) {
                    self.ch = (zoomImage.outerHeight() / self.options.zoomImageHeight) * self.zoomDiv.height();
                } else {
                    self.ch = (zoomImage.outerHeight() / self.options.zoomImageHeight) * self.zoomDiv.height();
                }
        ...
        _controlLoop: function () {
            ...
            if (this.lens) {
                ...
                if (this.IMG_zoomImage.width <= 1) {
                    this.destU = (((x) / this.zoomImage.outerWidth()) * self.options.zoomImageWidth) >> 0;
                } else {
                    this.destU = (((x) / this.zoomImage.outerWidth()) * self.options.zoomImageWidth) >> 0;
                }

                if (this.IMG_zoomImage.height <= 1) {
                    this.destV = (((y) / this.zoomImage.outerHeight()) * self.options.zoomImageHeight) >> 0;
                } else {
                    this.destV = (((y) / this.zoomImage.outerHeight()) * self.options.zoomImageHeight) >> 0;
                }
