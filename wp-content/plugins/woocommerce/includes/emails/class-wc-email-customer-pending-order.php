...
if ( ! class_exists( 'WC_Email_Customer_Pending_Order' ) ) :
 ...
 *
 * @class       WC_Email_Customer_Pending_Order
 * @version     2.0.0
 * @package     WooCommerce/Classes/Emails
 * @author      WooThemes
 * @extends     WC_Email
 */
class WC_Email_Customer_Pending_Order extends WC_Email {
	...
	public function __construct() {
		...
		add_action( 'woocommerce_order_status_pending_notification', array( $this, 'trigger' ) );
...
return new WC_Email_Customer_Pending_Order();
